...
import { btn2, colors, horizon, navbtn, navbtnin } from '../Globals/styles'
                                        ...
                                        <View style={styles.cartcardin}>
                                            ...
                                            {item.Addonquantity > 0 &&
                                                <View style={styles.c2}>
                                                    <Text style={styles.txt3}>{item.Addonquantity}&nbsp;{item.data.foodAddOnPrice}</Text>
                                                    <Text style={styles.txt3}>₹{item.data.foodAddOn}/each</Text>
                                                </View>}
