...
import { btn1, btn2, colors, hr80, navbtn, navbtnin, navbtnout, nonveg, veg } from '../Globals/styles';
import { AntDesign } from '@expo/vector-icons';

import { firebase } from '../../Firebase/firebaseConfig'

import { incdecbtn, incdecinput, incdecout } from '../Globals/styles';
                ...
                <View style={styles.s2}>
                    ...
                    <View style={styles.container2}>
                        ...
                        <View style={styles.container2in}>
                            ...
                            <View style={styles.dash}></View>
                            <Text style={styles.txt3}>{data.resturantAddressCity}</Text>
                        </View>
                    </View>
                            ...
                            {data.foodAddOn ?
                                <Text style={styles.txt6}>₹{
                                    ((parseInt(data.FoodPrice) * parseInt(quantity))
                                        + parseInt(addonquantity) * parseInt(data.foodAddOn)).toString()
