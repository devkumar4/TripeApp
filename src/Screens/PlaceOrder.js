...
import { btn1, colors, horizon, navbtn, navbtnin } from '../Globals/styles';
        ...
        if (cartdata != null) {
            ...
            foodprice.map((item) => {
                ...
                totalfoodprice = (parseInt(item.data.FoodPrice) * parseInt(item.Foodquantity)) +
                    (parseInt(item.data.foodAddOn) * parseInt(item.Addonquantity)) + totalfoodprice;
            })
        ...
        <ScrollView style={styles.containerout}>
            ...
            <View style={styles.container}>
                            ...
                            <View style={styles.rowout}>
                                ...
                                <View style={styles.row}>
                                    <View style={styles.left}>
                                        ...
                                        <Text style={styles.title}>{item.data.foodAddOnPrice}</Text>
                                        <Text style={styles.price1}>₹{item.data.foodAddOn}</Text>
                                    </View>
                                    <View style={styles.right}>
                                        <Text style={styles.totalprice}>₹{parseInt(item.Addonquantity) * parseInt(item.data.foodAddOn)}</Text>
                                    </View>
                                </View>
                            </View>
                        )
                ...
                <View style={styles.row}>
                    ...
                    <View style={styles.left}>
                        <Text style={styles.totalprice2}>₹{totalCost}/-</Text>
                    </View>
                </View>
