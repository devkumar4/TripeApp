...
var extract = (r, e, t) => {
  ...
  } else if (t instanceof f || t instanceof v) {
    r.set(e, t);
  } else {
    s.add(t);
...
var v = "undefined" != typeof Blob ? Blob : NoopConstructor;
...
var sanitizeDocument = r => r.split(l).map(replaceOutsideStrings).join("").trim();
...
var serializeBody = (r, e) => {
  if (e && !("query" === r.kind && !!r.context.preferGetMethod)) {
    ...
    var a = (r => {
      var e = new Map;
      if (f !== NoopConstructor || v !== NoopConstructor) {
        s.clear();
  ...
  try {
    ...
    if (/multipart\/mixed/i.test(i)) {
      f = async function* parseMultipartMixed(r, e) {
        ...
        var o = !0;
        var n;
        for await (var s of split(streamBody(e), a)) {
          if (o) {
            o = !1;
          } else {
            try {
    ...
    for await (var v of f) {
      n = n ? mergeResultPatch(n, v, s) : makeResult(r, v, s);
      a = !1;
      yield n;
      a = !0;
    }
